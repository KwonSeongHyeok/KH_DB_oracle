...
작성 방법
INSERT INTO 테이블명 (컬럼명1, 컬럼명2, 컬럼면3, ...)
...
(
  M_ID NUMBER(20, 0) 
, M_NAME VARCHAR2(225 BYTE) 
, M_AGE VARCHAR2(20 BYTE) 
, M_PHONE VARCHAR2(11 BYTE) 
, M_DATE VARCHAR2(225 BYTE) 
)
...
VALUES (1, '메가커피', '서울시 강남구 광남동', '02-888-8888', '영업시간 : 09:00 ~ 18:00');
