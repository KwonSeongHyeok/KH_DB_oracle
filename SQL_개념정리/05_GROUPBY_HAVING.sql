...
여러개의 결과 값을 산출하기 위해 그룹 함수가 적용된 그룹의 기준을 ORDER BT절에 기술해서 사용
...
-- 부서코드 오름차순으로 정렬
 ...
 /*
 ELPLOYEE 테이블에서 부서코드(DEPT_CODE) 직급코드(JOB_CODE)각 코드별로
...
-- 부서별 평균 급여가 3000000 원 이상이 부서를 조회하고 부서코드 오름차순 정렬
...
D2  	총합   	6520000 <-- D2 부서 전체의 급여 합계 (소계)
D5	    J3  	3500000 <-- D5 부서의 J3 직급 급여 합계
D5	    J5  	8460000 <-- D5 부서의 J5 직급 급여 합계
D5	    J7  	3800000 <-- D5 부서의 J7 직급 급여 합계
D5	    총합	15760000 <-- D5 부서 전체의 급여 합계 (소계)
D6	    J3  	73000000 <-- D6 부서의 J3 직급 급여 합계
D6	    J4  	2800000 <-- D6 부서의 J4 직급 급여 합계
D6	    총합	10100000 <-- D6 부서 전체의 급여 합계 (소계)
D8	    J6  	6986240 <-- D8 부서의 J6 직급 급여 합계
D8	    총합	6986240 <-- D8 부서 전체의 급여 합계 (소계)
D9	    J1  	8000000 <-- D9 부서의 J1 직급 급여 합계
D9	    J2  	9700000 <-- D9 부서의 J2 직급 급여 합계
D9  	총합	17700000 <-- D9 부서 전체의 급여 합계 (소계)
null	J6	    2320000
null	J7	    2890000
null	총합	5210000
null	null	70096240 <- 전체 부서의 급여 합계
...
-- * 그룹으로 지정된 모든 그룹에 대한 집계와 총합계를 구하는 함수
...
null	null	70096240 <-- 전체 데이커의 급여 합계 (총계)
*/ 
...
-- 주의할점: 집합연산에 사용되는 SELECT 문은 SELECT절이 동일해야함
