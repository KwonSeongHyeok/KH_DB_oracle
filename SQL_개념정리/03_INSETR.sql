...
한 후 에 반드시 COMMIT이나 ROLLBACK 진행할 것
...
-- 모두 INSERT 해줄 것이기 때문에 컬러명 생략
INSERT INTO EMPLOYEE2 VALUES(800, '동그라미', '870814-2123456', 'won@or.kr',  '01076996190', 'D1', 'J7', 'S3', 4300000, 0.2, 200, SYSDATE, NULL, 'N');
...
-- INSERT에서 특정 부분을 선택해서 넣을 떄는 컬럼명을 작성해서 넣어줌
...
-- DEPARTMENT2 테이블에서 DEPT_ID가 'D9'인 부서를
-- 전략기획팀으로 수정
UPDATE DEPARTMENT2
