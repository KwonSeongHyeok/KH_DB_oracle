...
CUSTOMER_EMAIL VARCHAR2(100) CONSTRAINT C_M_U UNIQUE,
CUSTOMER_PHONE VARCHAR2(20), CONSTRAINT C_P_UNIQUE UNIQUE(CUSTOMER_PHONE),
CUSTOMER_ADDRESS VARCHAR2(255)
);

-- ALTER TABLE PRODUCT RENAME COLUMN PRODUCT_PRICAE TO PRODUCT_PRICE;
...
CREATE TABLE FOOD_COMPANY(
    ...
    COMPANY_PHONE VARCHAR2(20)                  -- 회사 번호
);
...
CREATE TABLE SOFTS(
    ...
    SOFTS_NAME VARCHAR(100) NOT NULL,
...
DELETE FROM DRINK_COMPANY WHERE DRINK_NAME = '고가콜라';
